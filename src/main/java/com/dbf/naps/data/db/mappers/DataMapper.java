...
public interface DataMapper {
	...
	@Select("<script>"
			...
			+ "<if test=\"function.name() == 'P50'\">percentile_cont(0.50) within group (order by d.data)</if>"
			+ "<if test=\"function.name() == 'P95'\">percentile_cont(0.95) within group (order by d.data)</if>"
			+ "<if test=\"function.name() == 'P98'\">percentile_cont(0.98) within group (order by d.data)</if>"
			+ "<if test=\"function.name() == 'P99'\">percentile_cont(0.99) within group (order by d.data)</if>"
