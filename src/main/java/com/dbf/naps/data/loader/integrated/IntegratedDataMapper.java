...
public interface IntegratedDataMapper {
	...
	@Insert({"<script>", 
        "INSERT into naps.integrated_data (site_id, pollutant_id, date_time, year, month, day, fine, day_of_week, sample_mass, sample_vol, tsp, data) "
        + "values ",
        ...
        + "#{record.sample_mass}, #{record.sample_vol}, #{record.tsp}, #{record.data}"
        + "</foreach>"
